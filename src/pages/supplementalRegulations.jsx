...
import '../App.css';
class supplementalRegulations extends Component {
  render() {
    ...
    return (
      <div>
        <article>
          <header>
            <h1 className="entry-title">UBCSCC Supplemental Regulations</h1>
          </header>
          <div className="entry-content">
            <h3>2016/17 Supplemental Regulations</h3>
            <p>
              Held under the 2015 CACC General Competiton Rules and SoloSport – AutoSlalom Events Rules. All CACC rules apply except where superseded by UBCSCC Supplemental Regulations.
            </p>
            <h3>REGULATIONS</h3>
            <ul>
              <li>
              ...
              <li>
                Snell/DOT 2005 helmets are required to be worn by anyone in a vehicle that is competing, this includes passengers and drivers.
              </li>
              <li>
            ...
            <h3>DAMAGE TO EQUIPMENT/FACILITY</h3>
            <ul>
              <li>
...
export default supplementalRegulations;